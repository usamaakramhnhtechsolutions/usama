...
const AddInstructor = () => {
  ...
  const addapi = () => {
    setLoader(true);
      ...
      var config = {
        method: "POST",
        url: `${BaseUrl.baseurl}instructor/store`,
        data: data,
        headers: {
      ...
      console.log(error,'inructor errors')
          ...
          <div className="row justify-content-center p-3">
            <div className="col-md-6 boxsh ">
              <div className="card  px-2 py-4 rounded-4">
                <h3 className="text-danger text-center py-2 ">ADD Instructor</h3>
