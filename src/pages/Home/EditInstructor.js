...
const EditInstructor = () => {
    ...
    const editIns=()=>{
      ...
      var config = {
        method: "get",
        url: `${BaseUrl.baseurl}instructor/edit/${id}`,
        headers: {
      ...
      axios(config).then((response)=>{
        ...
        const {user_name, email, phone_no} = (response?.data?.data)
        setName(user_name)
        setEmail(email)
        setPhone(phone_no)
    ...
    const addapi = () => {
      ...
      try {
        ...
        var config = {
          method: "POST",
          url: `${BaseUrl.baseurl}instructor/update/${id}`,
          data: data,
          headers: {
            Accept: "application/json",
            Authorization: `Bearer ${token}`,
        ...
        axios(config)
          .then(function (response) {
            ...
            if (response.data.status === true) {
              ...
              Swal.fire({
                title: "Good job! ",
                text: "Instructor Update Success",
                icon: "success",
                button: "Ok",
              });
            ...
            <div className="row justify-content-center p-3">
              <div className="col-md-6 boxsh ">
                <div className="card  px-2 py-4 rounded-4">
                  <h3 className="text-danger text-center py-2 ">Update Instructor</h3>
